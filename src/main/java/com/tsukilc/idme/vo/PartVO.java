...
/**
 * 物料视图对象
 * 严格参照 openapi.yaml 的 Part schema
 */
@Data
@AllArgsConstructor
@NoArgsConstructor
public class PartVO {
    ...
    // TODO: 与Entity保持一致，改为Integer
    private Integer stockQty;  // 库存数量
    
    private String unit;  // 计量单位
    
    private String supplierName;  // 供应商名称（从ObjectReference提取displayName）
    private String category;  // 物料分类名称（从ObjectReference提取displayName）
    
    private String businessVersion;  // 业务版本号
    private String versionNumber;  // 系统版本号（对应SDK的version字段）
